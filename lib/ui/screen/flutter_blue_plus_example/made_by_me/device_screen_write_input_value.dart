...
import 'package:ntut_utl_mobile_app/ui/widgets/flutter_blue_plus_example/made_by_me/service_tile_write_input_value.dart';

class DeviceScreenWriteInputValue extends StatefulWidget {
  final BluetoothDevice device;

  const DeviceScreenWriteInputValue({super.key, required this.device});

  @override
  State<DeviceScreenWriteInputValue> createState() => _DeviceScreenWriteInputValueState();
}

class _DeviceScreenWriteInputValueState extends State<DeviceScreenWriteInputValue> {
  int? _rssi;
  int? _mtuSize;
  ...
  CharacteristicTileWriteInputValue _buildCharacteristicTile(BluetoothCharacteristic c) {
    return CharacteristicTileWriteInputValue(
      characteristic: c,
      descriptorTiles: c.descriptors.map((d) => DescriptorTileWriteInputValue(descriptor: d)).toList(),
    );
  }
